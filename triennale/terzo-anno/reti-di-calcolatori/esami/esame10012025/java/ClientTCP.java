...
public class ClientTCP {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /* Servizi fino ad EOF --------------------------------------------------- */
        System.out.println("Inserisci il servizio: 1= AGGIUNGI PRENOTAZIONE, 2= TRASFERISCI BADGE");    
        while ((servizio = stdIn.readLine()) != null) {
            ...
            if (servizio.equals("1")) {
                ...
                riga = inSock.readInt();
                colonna = inSock.readInt();

                System.out.println("Risultato ottenuto: [" + riga+ ", " + colonna + "]"); 
            }
