...
<jsp:useBean id="articoliManager" class="beans.ArticoliManager" scope="application" />
...
<form id="textForm" method="POST" action="dataServlet">
	<input id="userText" name="articolo"/>
</form>
